...
parser.add_argument('--model', type=str, default='mymy', help='model of experiment, options: [timese]')
...
parser.add_argument('--c_in', type=int, default=12, help='encoder input size')
parser.add_argument('--c_out', type=int, default=12, help='encoder input size')
parser.add_argument('--d_model', type=int, default=512, help='dimension of model')#32
...
parser.add_argument('--input', type=int, default=11, help='input dimension')
