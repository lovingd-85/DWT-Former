...
parser.add_argument('--data_path', type=str, default='Competation_Data.csv', help='data file')
...
parser.add_argument('--c_in', type=int, default=9, help='encoder input size')
parser.add_argument('--c_out', type=int, default=9, help='encoder input size')
...
parser.add_argument('--input', type=int, default=9, help='input dimension')
